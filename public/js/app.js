...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_Home__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__views_Register__ = __webpack_require__(24);
...
var router = new __WEBPACK_IMPORTED_MODULE_0_vue_router__["a" /* default */]({
    ...
    routes: [{
        ...
        path: '/register',
        name: 'Register',
        component: __WEBPACK_IMPORTED_MODULE_3__views_Register___default.a
    }]
});
...
var update = __webpack_require__(7)("0c5e5cca", content, false, {});
...
var render = function() {
  ...
  return _c("div", { staticClass: "home" }, [
    _c(
      ...
      [
        _c("router-link", { staticClass: "fr", attrs: { to: "/register" } }, [
          _vm._v("\n            Register\n        ")
        ])
      ],
      1
...
var staticRenderFns = [
  function() {
    ...
    return _c("span", { staticClass: "logo" }, [
      _c("span", { staticClass: "lara" }, [_vm._v("Lara")]),
      _c("span", { staticClass: "vel" }, [_vm._v("vel")])
    ])
  }
]
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(7)("431677e6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
    ...
    methods: {
        onSubmit: function onSubmit(e) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/api/register', this.user).then(function (response) {
                ...
                _this.response.success = response.data.success, _this.response.message = 'User successfully registered.';
            }).catch(function (error) {
                _this.showStatus = true;
                _this.response.success = error.response.data.success;
                _this.response.message = error.response.data.message;
            });
        }
    }
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "registration" }, [
    _c("div", { staticClass: "registration-wrapper card" }, [
          ...
          [
            ...
            _c(
              "div",
              {
                ...
                class: [
                  "alert",
                  _vm.response.success ? "alert-success" : "alert-danger"
                ]
              },
              [
                _vm._v(
